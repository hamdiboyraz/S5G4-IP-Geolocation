...
var cardComponent = function cardComponent(data) {
  ...
  var pLatLong = document.createElement("p");
  var pCity = document.createElement("p");
  var pTime = document.createElement("p");
  var pExchange = document.createElement("p");
  var pISP = document.createElement("p");
  h3IP.textContent = data.sorgu;
  pCountry.textContent = "".concat(data.ülke, " (").concat(data.ülkeKodu, ")");
  pLatLong.textContent = "Enlem: ".concat(data.enlem, " Boylam: ").concat(data.boylam);
  pCity.textContent = "\u015Eehir: ".concat(data.şehir);
  pTime.textContent = "Saat dilimi: ".concat(data.saatdilimi);
  pExchange.textContent = "Para birimi: ".concat(data.parabirimi);
  pISP.textContent = "ISP: ".concat(data.isp);
